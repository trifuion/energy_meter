// based on project from https://solarduino.com/diy-dc-energy-meter-with-arduino/
...
/* 1- DC Voltage Measurement using Voltage Divider Method */
        ...
        float R1 = 47470; //30000.0;                         // Input resistance value for R1 (in ohm) based on Voltage Divider Method 
        float R2 = 8340; //7500.0;                          // Input resistance value for R2 (in ohm) based on Voltage Divider Method 
...
/* 2- DC Current Measurement */
        ...
        /* 2.1- DC Current Offset */
              ...
              float currentOffset =0.07 ;           // to Offset deviation and accuracy. Offset any fake current when no current operates. 
